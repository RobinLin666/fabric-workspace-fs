...
This guide documents the detailed namespace, permissions, consistency model,
platform boundaries, and development workflow for `fabric-workspace-fs`.
Start with the [project README](../README.md) for installation and a minimal
mount example.
